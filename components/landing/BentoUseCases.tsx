...
export function BentoUseCases() {
  return (
    <section id="use" className="relative py-32 px-6 md:px-12 bg-obsidian-900">
      <div className="max-w-6xl mx-auto">
        <div className="mb-16 max-w-2xl">
          <span className="text-[10px] uppercase tracking-[0.5em] text-silver-muted">Who it's for</span>
          <h2 className="font-display text-4xl md:text-6xl leading-tight mt-3 text-silver">
        ...
        <div className="grid md:grid-cols-4 md:auto-rows-[180px] gap-4">
          {CARDS.map((c, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className={`glass rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden group ${c.span}`}
            ...
            >
              ...
              />
              <span className="text-[10px] uppercase tracking-[0.3em] text-silver-muted relative">
                {c.label}
              </span>
              <div className="relative">
                <h3 className="font-display text-2xl md:text-3xl text-silver leading-tight mb-2">
                  {c.title}
                </h3>
